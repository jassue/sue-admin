...
class InitSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AdminRules::createMany([
            ...
            ['id'=>4, 'parent_id'=>3, 'name'=>'菜单列表', 'url'=>'/admin/menu'],
            ['id'=>5, 'parent_id'=>4, 'name'=>'添加菜单', 'url'=>'/admin/menu/create'],
            ['id'=>6, 'parent_id'=>4, 'name'=>'编辑菜单', 'url'=>'/admin/menu/edit'],
            ['id'=>7, 'parent_id'=>4, 'name'=>'删除菜单', 'url'=>'/admin/menu/delete'],
            ['id'=>8, 'parent_id'=>3, 'name'=>'角色列表', 'url'=>'/admin/role'],
            ['id'=>9, 'parent_id'=>8, 'name'=>'添加角色', 'url'=>'/admin/role/create'],
            ['id'=>10, 'parent_id'=>8, 'name'=>'编辑角色', 'url'=>'/admin/role/edit'],
            ['id'=>11, 'parent_id'=>8, 'name'=>'分配权限', 'url'=>'/admin/role/assign'],
